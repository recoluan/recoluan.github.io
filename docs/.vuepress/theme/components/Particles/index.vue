...
export default {
  ...
  mounted() {
    ...
    if (!(themeConfig.showParticles != undefined && !themeConfig.showParticles)) {
      this.particlesConfig = themeConfig.particlesConfig || {}
    }
    ...
    createParticle () {
          ...
          p(e, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return (
                  (t.style.cssText =
                    "display:block;position:fixed;top:0;left:0;right:0;bottom:0;overflow:hidden;pointer-events:none;z-index:" +
                    (e = this.c).zIndex +
                    ";opacity:" +
                    e.opacity),
      ...
      new y(
        ...
        ((w = document.getElementsByTagName("script")),
        {
          ...
          count: Number(b.count) || 60
        })
      );
      //   var Particle = function (arg) {
      //     var w, b;
      //     new y(document.body, (w = document.getElementsByTagName("script"), {
      //       zIndex: (b = arg).zIndex || -1,
      //       opacity: b.opacity || 0.5,
      //       color: b.color || '0, 0, 0',
      //       pointColor: b.pointColor || '0, 0, 0',
      //       count: Number(b.count) || 60
