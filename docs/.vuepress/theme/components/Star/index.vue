...
html {
  height: 100%;
  // background-image: -webkit-radial-gradient(ellipse farthest-corner at center top, #444 0%, #888 100%);
  // background-image: radial-gradient(ellipse farthest-corner at center top, #444 0%, #888 100%);
  cursor: move;
}
