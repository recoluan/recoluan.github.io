import{_ as t,r as l,o as r,c,a as n,b as s,d as e,e as i}from"./app-Bwk_BGmh.js";const o={},p={class:"custom-container tip"},d=i('<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M12 8h.01"></path><path d="M11 12h1v4h1"></path></g></svg><p class="custom-container-title">TIP</p>',2),u={href:"https://fennay.github.io/gitlab-ci-cn/",target:"_blank",rel:"noopener noreferrer"},v=i(`<h2 id="gitlab-ci" tabindex="-1"><a class="header-anchor" href="#gitlab-ci"><span>Gitlab CI</span></a></h2><p>Gitlab-CI 是 GitLab Continuous Integration（Gitlab持续集成）的简称。 从Gitlab的8.0版本开始，gitlab就全面集成了Gitlab-CI,并且对所有项目默认开启。 只要在项目仓库的根目录添加.gitlab-ci.yml文件，并且配置了Runner（运行器），那么每一次合并请求（MR）或者push都会触发CI pipeline。</p><h2 id="gitlab-runner" tabindex="-1"><a class="header-anchor" href="#gitlab-runner"><span>Gitlab-Runner</span></a></h2><h4 id="安装gitlab-ci-multi-runner-linux" tabindex="-1"><a class="header-anchor" href="#安装gitlab-ci-multi-runner-linux"><span>安装gitlab-ci-multi-runner（linux）</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 添加yum源</span>
...
pages:
 ...
 only:
 - master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),m={href:"https://fennay.github.io/gitlab-ci-cn/gitlab-ci-yaml.html",target:"_blank",rel:"noopener noreferrer"},b=i(`<h2 id="其他" tabindex="-1"><a class="header-anchor" href="#其他"><span>其他</span></a></h2><h4 id="代码推送到gitlab上之后-一直是pending状态-要等很久才pick到一个runner来执行" tabindex="-1"><a class="header-anchor" href="#代码推送到gitlab上之后-一直是pending状态-要等很久才pick到一个runner来执行"><span>代码推送到gitlab上之后，一直是pending状态，要等很久才pick到一个runner来执行</span></a></h4><p>这个现象一般发生在本机注册了多个runner，之前的都删除了，只留下一个，但是当我们在gitlab管理平台移除了某个runner的时候，并没有完全删除记录，当执行的 <code>gitlab-ci-multi-runner list</code> 的时候你会发现它仍然还在，如果需要彻底删除它，还应该这样做：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /etc/gitlab-runner
<span class="token function">ls</span>

<span class="token comment"># 你会看到config.toml文件，打开它并删除已有的那些runner记录</span>
<span class="token function">vim</span> config.toml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="配置node环境" tabindex="-1"><a class="header-anchor" href="#配置node环境"><span>配置node环境</span></a></h4><ol><li>下载node-v9.11.1-linux-x64.tar.xz文件</li><li>例如放在 <code>/home</code> 文件夹<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 进入所在目录，解压</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><h4 id="scp上上传" tabindex="-1"><a class="header-anchor" href="#scp上上传"><span>scp上上传</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 普通</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是下载，调换顺序</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">scp</span> root@192.168.0.226:/data/ftp/http/files/ ./public/*
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,10),g={href:"http://recoluan.gitlab.io",target:"_blank",rel:"noopener noreferrer"},h=n("strong",null,"午后南杂",-1);function k(f,x){const a=l("ExternalLinkIcon");return r(),c("div",null,[n("div",p,[d,n("p",null,[s("在我们完成项目开发后，提交到git，当监听提交后，自动进行编译，并进行项目的部署，是不是一想就很爽，所以下面引入我们的主角 —— gitlab-CI，"),n("a",u,[s("中文文档"),e(a)]),s("。")])]),v,n("p",null,[s("具体配置见"),n("a",m,[s("文档"),e(a)])]),b,n("p",null,[s("个人博客："),n("a",g,[h,e(a)])])])}const w=t(o,[["render",k],["__file","121201.html.vue"]]),y=JSON.parse('{"path":"/blogs/other/2018/121201.html","title":"gitlab-CI 持续集成以及runner的配置简版","lang":"zh-CN","frontmatter":{"title":"gitlab-CI 持续集成以及runner的配置简版","tags":["gitlab","runner"],"categories":["other"],"date":"2018-12-12T00:00:00.000Z"},"headers":[{"level":2,"title":"Gitlab CI","slug":"gitlab-ci","link":"#gitlab-ci","children":[]},{"level":2,"title":"Gitlab-Runner","slug":"gitlab-runner","link":"#gitlab-runner","children":[]},{"level":2,"title":"配置 gitlab-runner.yml","slug":"配置-gitlab-runner-yml","link":"#配置-gitlab-runner-yml","children":[]},{"level":2,"title":"其他","slug":"其他","link":"#其他","children":[]}],"git":{"createdTime":1590769810000,"updatedTime":1590769810000,"contributors":[{"name":"reco_luan","email":"recoluan@outlook.com","commits":1}]},"filePathRelative":"blogs/other/2018/121201.md"}');export{w as comp,y as data};
